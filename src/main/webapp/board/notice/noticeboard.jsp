...
table.type10 tr:first-child th:first-child {
	border-top-left-radius: 10px;
}

/* top-right border-radius */
table.type10 tr:first-child th:last-child {
	border-top-right-radius: 10px;
}

/* bottom-left border-radius */
table.type10 tr:last-child td:first-child {
	border-bottom-left-radius: 10px;
}

/* bottom-right border-radius */
table.type10 tr:last-child td:last-child {
...
<body>
	...
	<hr />
	<div align="center">
		<table class="type10" style="margin-bottom: 10px; TABLE-layout: fixed">
			<col width="100" />
			<col width="500" />
			<col width="200" />
			<col width="150" />
