    ...
    <div id="body">
        <div id="reco_place_div">
            <div id="reco_place">
                <div id="introduce">
                    ...
                    <p>This is a list of travel destinations recommended by our site.<br> I want you to experience
                        Korean culture.</p>
                </div>
                <div id="reco_place_info">
                    <div class="reco_img">
                        <div>
                            <a href="#">
                                <figure class="img_border"><img src="etc/image/img/img_2.jpg" alt="Seoul">
        ...
        <div id="reviews_div">
            <div id="introduce">
                <h2>Review Board</h2>
                <p>
                    This section is review board.<br>
                    Please share your review with others from your experience.
                </p>
            </div>
